...
\date{Modified: 25 September, 2014. Compiled: \today}
...
The \Rpackage{GenomicTuples} \R{} package defines general purpose containers
...
will be of benifit in understanding the \Rpackage{GenomicTuples} package.}
...
behaviour in future versions of \Rpackage{GenomicTuples}.
...
\Rpackage{GenomicTuples} uses heavily and is based upon.
