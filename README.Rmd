...
Get the latest stable `R` release from [CRAN](http://cran.r-project.org/). Then install **GenomicTuples** from [Bioconductor](http://bioconductor.org/) using the following code:
...
And the development version from [GitHub](https://github.com/PeteHaitch/GenomicTuples) with:
